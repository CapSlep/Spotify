...
const openSpotifyCheckout = () => {
  document.querySelector("#spotifyCheckout").setAttribute("style", "display: flex");
};
const closeSpotifyCheckout = () => {
  document.querySelector("#spotifyCheckout").setAttribute("style", "display: none");
};
